	...
	"jobs": [
		{
			...
			"description": "Responsible for reviewing of project for compliance to AT&T security" + 
							"mandates during design.  Responsible for software security scans via McAfee EVM scan engine" + 
							"for new and upgraded software and hardware projects and authoring of suggested security remediation" + 
							"for discovered security vulnerabilities. Responsible for reviews and authoring of Security Consultation" +
							"reports for NTD (Network Technology Development), Project Security Checklists as required by AT&T Mobility," +
							"Cloud, and Enterprise project teams to include authoring of suggested security remediations for vendors’ " +
							"non-compliance to ASPR (AT&T Security Policy Requirements)."
		},
		{
			"employer":  "AT&T Mobility",
			...
			"description": "Responsible for Equipment Engineering and Implementation Engineering duties for core switchs. Responsible" + 
			"to work in a hands-on relationship with key infrastructure vendors to ensure compliance with AT&T’s equipment installation" + 
			"and cabling standards for Data Center and MTSO (Mobile Telephone Switch Office) projects. Responsible for the development " + 
			"of ancillary capital budget to support MSC, MSN, DCS, Voicemail, SGSNs and USGSNs growth and new network deployments in the" + 
